...
const CATEGORY_DATA = [
    { id: 'work', title: 'Trabajo', icon: <BriefcaseIcon />, color: '#5e5ce6', bgLight: 'rgba(94, 92, 230, 0.15)' },
    { id: 'study', title: 'Estudio', icon: <BookOpenIcon />, color: '#32ade6', bgLight: 'rgba(50, 173, 230, 0.15)' },
    { id: 'health', title: 'Salud', icon: <HeartPulseIcon />, color: '#ff3b30', bgLight: 'rgba(255, 59, 48, 0.15)' },
    { id: 'home', title: 'Hogar', icon: <HomeIcon />, color: '#ffcc00', bgLight: 'rgba(255, 204, 0, 0.15)' },
    { id: 'other', title: 'Otro', icon: <MonitorIcon />, color: '#8e8e93', bgLight: 'rgba(142, 142, 147, 0.15)' }
];
                    ...
                    return (
                        <div key={cat.id} className="scroll-item category-card glass-panel-soft">
                            ...
                            <div className="cat-info">
                                <h4>{cat.title}</h4>
                                <p>{count} {count === 1 ? 'Tarea' : 'Tareas'}</p>
                            </div>
                            <button
                                className="cat-add-btn"
                                style={{ backgroundColor: cat.color }}
                                onClick={() => onAddCategoryTask(cat.id)}
                                aria-label={`Añadir a ${cat.title}`}
                            >
                                <PlusIcon />
                            </button>
                        </div>
